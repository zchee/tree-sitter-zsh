...
HOMEPAGE_URL := https://github.com/zchee/tree-sitter-zsh
VERSION := 1.0.0
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/zsh '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/zsh
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/zsh
